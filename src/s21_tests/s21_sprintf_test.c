...
START_TEST(octal_many) {
  ...
  long int val = 949149114140;
  long int val2 = 949149114140;
  ck_assert_int_eq(
      s21_sprintf(str1, format, val, (unsigned)14, (unsigned short)1441,
                  (unsigned)14414, (unsigned)9681),
      sprintf(str2, format, val2, (unsigned)14, (unsigned short)1441,
              (unsigned)14414, (unsigned)9681));
...
Suite *s21_sprintf_test(void) {
  ...
  s = suite_create("\033[34m \033[46m SPRINTF TESTS \033[0m");

  tc_s21_sprintf = tcase_create("sprintf_tc");
  // tcase_add_test(tc_s21_sprintf, common_test);
  // tcase_add_test(tc_s21_sprintf, null_test);
  // tcase_add_test(tc_s21_sprintf, find_space_test);
  // tcase_add_test(tc_s21_sprintf, str_exists_test);
  // tcase_add_test(tc_s21_sprintf, char_not_found_test);
  ...
  tcase_add_test(tc_s21_sprintf, test_sprintf26);
  tcase_add_test(tc_s21_sprintf, test_sprintf27);
